...
public class CharacterFollowing : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		// If reach the radius within the path then move to next point in path
		...
		// Move the character until the end point is reached in the path
		...
		// Move the vehice according to the velocity
